...
public class HomeScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // if you would put a toast in each of them, you would see: if you touch the seekBar then the second and the third method are called in this order;
        ...
        // below is set up the listener for the "Start Quiz" button
